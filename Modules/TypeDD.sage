...
class TypeDD:
	...
	def tensor(self, other):
		...
		MNgens = np.zeros((len(self.gens),len(other.gens)),dtype=object) # I think a list will be more efficient than a matrix, since it will probably be quite sparse, but we should discuss.
